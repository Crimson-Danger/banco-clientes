...
def ensure_runtime_indexes() -> None:
    ...
    statements = [
        ...
        "CREATE INDEX IF NOT EXISTS ix_client_occurrences_phone1_trgm ON client_occurrences USING GIN (telefone1 gin_trgm_ops)",
        "CREATE INDEX IF NOT EXISTS ix_client_occurrences_phone2_trgm ON client_occurrences USING GIN (telefone2 gin_trgm_ops)",
        "CREATE INDEX IF NOT EXISTS ix_client_occurrences_phone3_trgm ON client_occurrences USING GIN (telefone3 gin_trgm_ops)",
